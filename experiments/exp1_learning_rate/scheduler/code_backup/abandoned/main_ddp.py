...
parser.add_argument('-a',
                    ...
                    default='resnet18',
                    choices=model_names,
                    help='mymodel architecture: ' + ' | '.join(model_names) +
                    ' (default: resnet18)')
...
parser.add_argument('-e',
                    ...
                    dest='evaluate',
                    action='store_true',
                    help='evaluate mymodel on validation set')
parser.add_argument('--pretrained',
                    dest='pretrained',
                    action='store_true',
                    help='use pre-trained mymodel')
...
def main_worker(local_rank, nprocs, args):
    ...
    # create mymodel
    if args.pretrained:
        print("=> using pre-trained mymodel '{}'".format(args.arch))
        model = models.__dict__[args.arch](pretrained=True)
    else:
        print("=> creating mymodel '{}'".format(args.arch))
